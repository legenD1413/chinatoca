        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="mx-auto max-w-4xl space-y-6 text-center text-white">
            ...
            <h2 className="text-xl md:text-2xl lg:text-3xl">
              The <span className="text-royalblue-300">Fulfillment Solution</span> That Knows China-Canada Shipping Best
            </h2>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={index} className="flex items-start gap-2">
                    <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-burgundy-700" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="bg-white py-20">
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-12 flex justify-center">
            <Button className="bg-royalblue-700 hover:bg-royalblue-800">Learn More About Our Process</Button>
          </div>
        </div>
      </section>
